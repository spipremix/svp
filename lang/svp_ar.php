...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'confirmer_desinstaller' => 'تنبيه، يقوم إلغاء تثبيت اي ملحق <b>بحذف</b> بياناته من القاعدة بشكل نهائي.<br />اذا لم تكن متأكداً من الغائه، قم بإيقاف الملحق فقط.', # MODIF

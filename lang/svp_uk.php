...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'categorie_aucune' => 'Тематику не задано',
	...
	'config_activer_runtime_explication' => 'Якщо режим сумісності включено, то будуть показуватися лише плагіни, сумісні з поточною версією SPIP. Якщо режим сумісності вимкнено, то будуть показуватися всі плагіни незалежно від поточної версії.',
	'config_autoriser_activer_paquets_obsoletes' => 'Дозволити вмикати застарілі плагіни?',
	'config_autoriser_activer_paquets_obsoletes_explication' => 'Застарілі плагіни - це плагіни, встановлені на вашому сайті, які старіші за інші плагіни. Визначається за статусом плагіну (тестується, стабільний і т.д.), а також по номеру поточної версії. Увімкніть це налаштування, якщо хочете мати можливість використовувати застарілі плагіни.',
	...
	'erreur_dir_plugins_auto' => 'Папку “plugins/auto”, яка дозволяє додавати плагіни з адміністративної частни сайту, не створено або не вистачає прав для запису в неї. Якщо ви хочете мити таку можливість, то <strong>вам необхідно її створити або установити права доступи 777 (якщо така папка існує)</strong>.',
	...
	'info_admin_plugin_actif_non_verrou_tous' => 'Список відключених плагінів.',
	...
	'info_ajouter_depot' => 'Додавши репозиторій на сайт ви отримуєте можливість одержати інформацію про всі плагіни, які знаходяться в репозиторії. <br /> Назва та опис плагінів міститься в  XML файлі репозиторію.',
	...
	'info_charger_plugin' => 'Для того, щоб додати плагін, найдіть за допомогою системи пошуку. Пошук виконується тільки серед плагінів, сумісних в версією SPIP, використовуваною на сайті.',
	...
	'message_action_finale_off_ok' => 'Плагін “@plugin@” (version : @version@) успішно відключено',
	...
	'message_action_kill' => 'Видалити файли плагіну “@plugin@” (version : @version@)',
	...
	'message_action_up' => 'Поновити плагін “@plugin@” (с @version@ до @version_maj@)',
	...
	'message_nok_champ_obligatoire' => 'Поле, обов’язкове для заповнення',
	'message_nok_depot_deja_ajoute' => 'URL “@url@” відповідає вже доданому репозиторію',
	'message_nok_maj_introuvable' => 'Не вдалося знайти нову версію плагіна @plugin@ .',
	...
	'tout_decocher' => 'Усунути виділення'
);

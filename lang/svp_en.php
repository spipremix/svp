...
<strong> You must create it in order to install new plugins from that interface. </ strong>',
	...
	If you wish to disable them, please contact the webmaster of the site or see <a href="http://programmer.spip.net/repertoire_plugins-dist">the documentation</a>.', # MODIF

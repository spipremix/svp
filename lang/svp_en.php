...
<strong> You must create it in order to install new plugins from that interface. </ strong>',
	...
	'info_admin_plugin_verrouille' => 'This page lists the active and locked plugins (placed in the <code>@dir_plugins_dist@</code> directory). I you wish to disable them, please contact the webmaster of the site or see <a href="http://programmer.spip.org/directory_extensions">the documentation</a>.', # MODIF

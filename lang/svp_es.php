...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_admin_plugin_verrouille' => 'Esta página lista los plugins activos y bloqueados (situados en la carpeta <code>@dir_plugins_dist@</code>). Si quieres desactivarlos, contacta al webmaster del sitio, o consulta <a href="http://programmer.spip.org/repertoire_plugins_dist">à la documentación</a>.', # MODIF
